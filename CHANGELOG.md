...
- (deps) Update lodash to 4.18.1 ([!252](https://git.opentalk.dev/opentalk/frontend/integrations/outlook-add-in/-/merge_requests/252))
- (deps) Update yaml v1 ([!254](https://git.opentalk.dev/opentalk/frontend/integrations/outlook-add-in/-/merge_requests/254))

### Ci

- Use template for changelog preview job ([!253](https://git.opentalk.dev/opentalk/frontend/integrations/outlook-add-in/-/merge_requests/253))

## [0.3.4] - 2026-02-20

[0.3.4]: https://git.opentalk.dev/opentalk/frontend/integrations/outlook-add-in/-/compare/v0.3.3...v0.3.4

### 🐛 Bug fixes

- Broken config json ([!247](https://git.opentalk.dev/opentalk/frontend/integrations/outlook-add-in/-/merge_requests/247))
